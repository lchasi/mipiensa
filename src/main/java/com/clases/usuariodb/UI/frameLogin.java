...
public class frameLogin extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Usuario user = usuarioDAO.loginUsuario(txtUsuario.getText(), txtContrasena.getText());
       if (user!=null)
       {
       Main.usuarioId=user.getId();
       Main.usuarioNombre =user.getNombre();
       this.dispose();
       }
       else{
       txtMessage.setText("Usuario/pass incorrectos");
       }
